...
public class ProjectRepository implements ProjectRepositoryInterface {
	...
	public boolean addNewProject(Project projectDetails) {
		...
		Object[] parameters= {projectDetails.getProjectName(),projectDetails.getStartDate(), projectDetails.getEndDate(),projectDetails.getBudget()};
	...
	public Project UpdateProject(Project projectDetails) {
		Object[] parameters={projectDetails.getProjectName(),projectDetails.getStartDate(), projectDetails.getEndDate(),projectDetails.getBudget(),projectDetails.getProjectId()};
