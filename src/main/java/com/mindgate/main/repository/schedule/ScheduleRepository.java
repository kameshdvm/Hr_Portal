...
public class ScheduleRepository implements ScheduleRepositoryInterface {
	...
	private final static String SELECT_ALL_SCHEDULE = "select * from scheduled_details";
	private final static String SELECT_ONE_SCHEDULE="select * from scheduled_details where schedule_id=?";
